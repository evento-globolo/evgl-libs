...
use evgl_domain::{
    DeliveryMode, EventDraft, ManualAction, ProviderCapabilities, ProviderKind,
...
impl ProviderAdapter for CraigslistAdapter {
    fn kind(&self) -> ProviderKind { ProviderKind::Craigslist }
    ...
    fn capabilities(&self) -> ProviderCapabilities {
        ProviderCapabilities {
            ...
            notes: vec![
                ...
                "Evento Globolo prepares copy and opens the official posting flow for the user.".into(),
            ],
        }
    }
    ...
    fn authorization_url(
        ...
        Err(ProviderError::Unsupported("Craigslist has no general OAuth event-posting flow"))
    }
